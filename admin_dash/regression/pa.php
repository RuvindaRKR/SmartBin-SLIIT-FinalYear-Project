<?php 
	...
	$path2 .= "/admin_dash/regression/Includes/PolynomialRegression/PolynomialRegression.php";
	include($path2);

	$path3 = $_SERVER['DOCUMENT_ROOT']; 
	$path3 .= "/admin_dash/regression/gl.php";
	include($path3);
	
	$path4 = $_SERVER['DOCUMENT_ROOT']; 
	$path4 .= "/admin_dash/regression/pl.php";
	include($path4);
	
	$path5 = $_SERVER['DOCUMENT_ROOT']; 
	$path5 .= "/admin_dash/regression/bd.php";
	include($path5);
